				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group collapse in" id="frame-0">
							<a class="list-group-item" href="../mc/fangroup.php" kw="粉丝分组">粉丝分组</a>
							<a class="list-group-item" href="../mc/fans.php" kw="粉丝">粉丝</a>
						</ul>
						<div class="panel-heading">
						...
						<ul class="list-group collapse in" id="frame-1">
							<a class="list-group-item" href="../platform/cover.php" kw="会员中心访问入口">会员中心访问入口</a>
							<a class="list-group-item" href="../mc/member.php" kw="会员">会员</a>
							<a class="list-group-item" href="../mc/group.php" kw="会员组">会员组</a>
							<a class="list-group-item" href="../mc/creditmanage.php" kw="会员积分管理">会员积分管理</a>
							<a class="list-group-item" href="../mc/fields.php" kw="会员字段管理">会员字段管理</a>
							<a class="list-group-item" href="../mc/tplnotice.php" kw="会员微信通知">会员微信通知</a>
						</ul>
						<div class="panel-heading">
							<h4 class="panel-title">会员卡管理</h4>
							<a class="panel-collapse collapsed" data-toggle="collapse" href="#frame-2">
								<i class="fa fa-chevron-circle-down"></i>
							</a>
						</div>
						<ul class="list-group collapse in" id="frame-2">
							<a class="list-group-item" href="../platform/cover.php" kw="会员卡访问入口">会员卡访问入口</a>
							<a class="list-group-item" href="../mc/card.php" kw="会员卡管理">会员卡管理</a>
							<a class="list-group-item" href="../mc/business.php" kw="商家设置">商家设置</a>
							<a class="list-group-item" href="../activity/offline.php" kw="操作店员管理">操作店员管理</a>
						</ul>
						<div class="panel-heading">
							<h4 class="panel-title">积分兑换</h4>
							<a class="panel-collapse collapsed" data-toggle="collapse" href="#frame-3">
								<i class="fa fa-chevron-circle-down"></i>
							</a>
						</div>
						<ul class="list-group collapse in" id="frame-3">
							<a class="list-group-item" href="../activity/coupon.php" kw="折扣券">折扣券</a>
							<a class="list-group-item" href="../activity/token.php" kw="代金券">代金券</a>
							<a class="list-group-item" href="../activity/goods.php" kw="真实物品">真实物品</a>
							<a class="list-group-item" href="../wechat/manage.php" kw="微信卡券">微信卡券</a>
							<a class="list-group-item" href="../wechat/consume.php" kw="卡券核销">卡券核销</a>
						</ul>
						<div class="panel-heading">
						...
						<ul class="list-group collapse in" id="frame-4">
							<a class="list-group-item" href="../mc/broadcast.php" kw="群发消息&通知">群发消息&通知</a>
							<a class="list-group-item" href="../mc/mass.php" kw="微信群发">微信群发</a>
							<a class="list-group-item" href="../profile/notify.php" kw="通知参数">通知参数</a>
						</ul>
					</div>
