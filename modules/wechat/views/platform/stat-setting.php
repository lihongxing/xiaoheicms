				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<label for="msg_history_1" class="radio-inline"><input type="radio" name="msg_history" id="msg_history_1" value="1" checked="checked" > 是</label>
							<label for="msg_history_0" class="radio-inline"><input type="radio" name="msg_history" id="msg_history_0" value="0" > 否</label>
					...
					<div class="form-group msgd">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="msg_maxday" class="form-control" value="30" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<label for="rule_use_1" class="radio-inline"><input type="radio" id="rule_use_1" name="use_ratio" value="1" checked="checked" > 是</label>
							<label for="rule_use_0" class="radio-inline"><input type="radio" id="rule_use_0" name="use_ratio" value="0" > 否</label>
