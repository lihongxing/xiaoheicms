...
<ul class="nav nav-tabs">
	<li class="active"><a href="../profile/notify.php">邮件通知</a></li>
	<li><a href="../material/mass.php">微信通知</a></li>
</ul>
<script type="text/javascript">
	$("#smtp").show();
</script>
<div class="main">
	<form id="payform" action="../profile/notify.php" method="post" class="form-horizontal form">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label for="radio_3" class="radio-inline"><input type="radio" name="smtp[type]" id="radio_3" value="163" checked onclick="$('#smtp').hide();"/> 网易邮箱服务器（建议使用）</label>
						<label for="radio_4" class="radio-inline"><input type="radio" name="smtp[type]" id="radio_4" value="custom" onclick="$('#smtp').show();" /> 自定义</label>
				...
				<div class="tb" id="smtp" style="display:none;">
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="smtp[server]" class="form-control" value="" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="smtp[port]" class="form-control" value="" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<label for="radio_5" class="radio-inline"><input type="radio" name="smtp[authmode]" id="radio_5" value="1" checked /> 是</label>
							<label for="radio_6" class="radio-inline"><input type="radio" name="smtp[authmode]" id="radio_6" value="0" /> 否</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="sender" class="form-control" value="" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<textarea id="signature" style="height:150px;" name="signature" class="form-control" cols="60"></textarea>
