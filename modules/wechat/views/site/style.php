...
<ul class="nav nav-tabs">
	<li class="active"><a href="../site/style.php">模板管理</a></li>
</ul>
<style>
	...
	<div class="panel panel-default">
		<nav role="navigation" class="navbar navbar-default navbar-static-top" style="margin-bottom:0;">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav nav-btns">
					<li class="active">
						<a href="../site/style.php">全部</a>
					</li>
					<li>
						<a href="../site/style.php">常用模板</a>
					</li>
					<li>
						<a href="../site/style.php">酒店</a>
					</li>
					<li>
						<a href="../site/style.php">汽车</a>
					</li>
					<li>
						<a href="../site/style.php">旅游</a>
					</li>
					<li>
						<a href="../site/style.php">餐饮</a>
					</li>
					<li>
						<a href="../site/style.php">房地产</a>
					</li>
					<li>
						<a href="../site/style.php">医疗保健</a>
					</li>
					<li>
						<a href="../site/style.php">教育</a>
					</li>
					<li>
						<a href="../site/style.php">健身美容</a>
					</li>
					<li>
						<a href="../site/style.php">婚纱摄影</a>
					</li>
					<li>
						<a href="../site/style.php">其他行业</a>
					</li>
				</ul>
			</div>
		</nav>
		<div class="panel-body">
					<div class="item item-style active">
						<a class="fa fa-times"  onclick="if(!confirm('删除后将不可恢复,确定删除吗?')) return false;" title="删除风格" href="../site/style.php"></a>
						<div class="title">
							<div style="overflow:hidden; height:28px;">微站默认模板_Q28m </div>
							<a href="../site/style.php">
								<img src="../resource/images/preview.jpg" class="img-rounded" />
							</a>
							<span class="fa fa-check"></span>
						</div>
						<div class="btn-group  btn-group-justified">
							<a href="../site/style.php" class="btn btn-default btn-xs">设计风格</a>
							<a href="../site/style.php" class="btn btn-default btn-xs">复制风格</a>
							<a href="javascript:;" onclick="preview('4');return false;" class="btn btn-default btn-xs">预览</a>
						</div>
					</div>
				<!--下面为隐藏内容
					<div class="item" style="border-color:#FFF;">
						...
						<div class="item-build-div1">
							<div class="item-build-div2">
								<a href="../site/style.php" class="btn btn-warning item-build-btn" role="button" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="该模板尚未激活，激活后可正常使用！">点击激活</a>
							</div>
						</div>
						<div class="title">
...
<!--下面为隐藏内容
<div class="panel panel-default">
	<div class="panel-heading">覆盖模块模板HTML或是内容时，需要在当前风格目录即“app/themes/”下，新建同名模板，即可修改此模块模板内容。</div>
	<div class="table-responsive panel-body">
		<table class="table">
			...
			<tr>
				<td>/addons/1/template/mobile/1</td>
				<td style="color:red" >app/themes//1/1</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '1')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/default</td>
				<td style="color:red" >app/themes//1/default</td>
				<td><a href="javascript:;" onclick="createtemplate('1', 'default')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/微站默认模板</td>
				<td style="color:red" >app/themes//1/微站默认模板</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '微站默认模板')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/由微信提供默认微站模板套系</td>
				<td style="color:red" >app/themes//1/由微信提供默认微站模板套系</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '由微信提供默认微站模板套系')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/微信团队</td>
				<td style="color:red" >app/themes//1/微信团队</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '微信团队')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/http://012wz.com</td>
				<td style="color:red" >app/themes//1/http://012wz.com</td>
				<td><a href="javascript:;" onclick="createtemplate('1', 'http://012wz.com')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/1</td>
				<td style="color:red" >app/themes//1/1</td>
			...
			<tr>
				<td>/addons/1/template/mobile/0</td>
				<td style="color:red" >app/themes//1/0</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '0')">生成重定义模板</a></td>
			</tr>
			<tr>
				<td>/addons/1/template/mobile/</td>
				<td style="color:red" >app/themes//1/</td>
				<td><a href="javascript:;" onclick="createtemplate('1', '')">生成重定义模板</a></td>
			</tr>
		</table>
	</div>
</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" disabled value="./app/themes/">
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">基础图片目录</label>
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="style[imgdir]" value="" />
							<span class="help-block">风格基础图片存放的目录，如果为空则默认为./app/themes//images目录</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="style[fontfamily]" value="" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" class="form-control" name="style[fontsize]" value="" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<textarea name="style[css]" class="form-control" cols="120" rows="16"></textarea>
