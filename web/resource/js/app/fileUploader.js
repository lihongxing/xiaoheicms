	...
	var d = {
		...
		initRemote : function () {
			...
			b.modalobj.find(".btn-primary").click(function () {
				...
				c.length > 0 && a.getJSON("/upload/fetch.html?type=image", {
					url : c
				}, function (a) {
		...
		localPage : function (c) {
			...
			return a.getJSON("/upload/local.html?type=image", {
				page : c,
				year : e,
				month : f
			}, function (c) {
		...
		localAudioPage : function (c) {
			...
			return a.getJSON("/upload/local.html?type=audio&pagesize=5", {
				page : c
			}, function (c) {
				c = c.message,
		...
		initImageUploader : function () {
			...
			var q = {
				...
				server : "/upload/upload.html?type=image",
				chunked : !1,
				compress : !1,
				accept : {
					title : "Images",
